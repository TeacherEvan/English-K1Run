...
1. `/sounds/welcome_association.wav` - English phase 1
2. `/sounds/welcome_learning.wav` - English phase 2
3. `/sounds/welcome_association_thai.wav` - Thai translation of phase 1
4. `/sounds/welcome_learning_thai.wav` - Thai translation of phase 2
