export const ENGLISH_SENTENCE_TEMPLATES: Record<string, string> = {
  ...
  "8": "The number is eight",
  "9": "The number is nine",
  "10": "The number is ten",
  "11": "The number is eleven",
  "12": "The number is twelve",
  "13": "The number is thirteen",
  "14": "The number is fourteen",
  "15": "The number is fifteen",

  // Counting words (match game category targets)
  one: "The number is one",
  two: "The number is two",
  three: "The number is three",
  four: "The number is four",
  five: "The number is five",
  six: "The number is six",
  seven: "The number is seven",
  eight: "The number is eight",
  nine: "The number is nine",
  ten: "The number is ten",
