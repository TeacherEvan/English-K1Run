...
test.describe('Game Menu', () => {
    ...
    test('should have Level 1 (Fruits & Veggies) selected by default', async ({ gamePage }) => {
        ...
        await expect(firstButton).toContainText('Fruits & Veggies')
    })
    ...
    test('should have visible Start Race button', async ({ gamePage }) => {
        ...
        await expect(gamePage.menu.startButton).toContainText('Start Race')
    })

    test('should have visible Reset button', async ({ gamePage }) => {
        await expect(gamePage.menu.resetButton).toBeVisible()
        await expect(gamePage.menu.resetButton).toContainText('Reset to Level 1')
    })
    ...
    test('should display correct category after starting game', async ({ gamePage }) => {
